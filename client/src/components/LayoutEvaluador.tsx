...
export const LayoutEvaluador: React.FC = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 md:flex md:flex-row font-sans antialiased text-[#111827] w-full overflow-x-hidden">
      ...
      <header className="md:hidden bg-white border-b border-gray-100 px-4 py-3 flex items-center justify-between sticky top-0 z-50 h-13.25 w-full">
      ...
      {menuMovilAbierto && (
        <div className="md:hidden fixed inset-x-0 bottom-0 top-13.25 bg-white z-40 w-full overflow-y-auto animate-fade-in">
